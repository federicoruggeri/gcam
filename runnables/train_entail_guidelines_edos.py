...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'edos', 'entail-guidelines')
    ...
    config = GuidelineConfig.from_config(key=ConfigKey(dataset='edos', tags={'entail'}))
