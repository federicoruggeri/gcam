...
from modeling.guidelines import DotGuidelines
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'edos', 'dot-guidelines')
    ...
    config = GuidelineConfig.from_config(key=ConfigKey(dataset='edos', tags={'dot'}))
    ...
    for seed in config.seeds:
        ...
        model = DotGuidelines(hf_model_name=config.hf_model_name,
