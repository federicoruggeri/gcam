...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'tos', f'concat-guidelines_{category}')
    ...
    config = GuidelineConfig.from_config(key=ConfigKey(dataset='tos', tags={'concat'}))
