...
from modeling.guidelines import ConcatGuidelines
...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'edos', 'concat-guidelines')
    ...
    config = GuidelineConfig.from_config(key=ConfigKey(dataset='edos', tags={'concat'}))
    ...
    for seed in config.seeds:
        ...
        model = ConcatGuidelines(hf_model_name=config.hf_model_name,
