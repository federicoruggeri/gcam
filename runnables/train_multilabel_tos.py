...
if __name__ == '__main__':
    ...
    save_path = Path(__file__).parent.parent.resolve().joinpath('results', 'tos', f'multilabel_{category}')
    ...
    config = MultiLabelConfig.from_config(key=ConfigKey(dataset='tos'))
